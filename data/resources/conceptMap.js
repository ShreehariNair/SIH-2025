export default {
  ...
  status: "active",
  experimental: false,
  date: ISODate("2025-09-20T10:52:20Z"),
  ...
  useContext: [
    {
      ...
      valueCodeableConcept: {
        coding: [
          {
            system: "http://sih2025.in/CodeSystem/domain",
  ...
  approvalDate: ISODate("2025-09-15T00:00:00Z"),
  lastReviewDate: ISODate("2025-09-20T00:00:00Z"),
  effectivePeriod: {
    start: ISODate("2025-09-20T00:00:00Z"),
    end: ISODate("2026-09-20T00:00:00Z"),
  },
  topic: [
    {
      coding: [
  ...
  additionalAttribute: [
    {
      ...
      description: "Clinical context required for mapping (e.g., age, gender)",
      type: "string",
    },
  ],
  ...
  group: [
    {
      source: "https://api.sih2025.in/CodeSystem/namaste",
      target: "http://id.who.int/icd/entity/1639997017",
      element: [
        {
          code: "AYU1234",
          display: "Wind Pattern",
          target: [
            {
              code: "TM2-001",
              display: "ICD-11 Wind Pattern",
